...
import com.example.ianklobe_musicapp.databinding.FragmentRockBinding
            ...
            .getSongLists(param).enqueue(object : Callback<MusicResponse> {
                override fun onResponse(
                    ...
                    if (response.isSuccessful) {
                        val userAdapter = RandomSongAdapter(response.body()!!.results, ::playSongFragment)
                        binding.rvRockList.adapter = userAdapter
                    }
                }
